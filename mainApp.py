...
import os
from sensor.utils.utilities import read_yaml, load_object
...
from sensor.ml.model.predictor import ModelResolver,TargetValueMapping
...
def set_env_variable(env_file_path):
    ...
    try:
        if os.getenv('MONGO_DB_URL',None) is None:
            env_config = read_yaml(env_file_path)
