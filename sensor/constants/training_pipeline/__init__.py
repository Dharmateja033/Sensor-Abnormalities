from sensor.constants.aws_s3_bucket import TRAINING_BUCKET_NAME
import os
...
"""
DATA_INGESTION_COLLECTION_NAME: str = "kafka_sensor"
...
MODEL_TRAINER_FIITING_THRESHOLD: float = 0.05
...
"""
Model Deployment ralated constant start with  PUSHER VAR NAME
"""
