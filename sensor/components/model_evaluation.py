...
from sensor.ml.model.predictor import SensorModel ,ModelResolver ,TargetValueMapping
from sensor.utils.utilities import save_object,load_object,write_yaml_file
...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            if improved_accuracy > self.model_eval_config.replacement_threshold :
                is_model_accepted=True
            else:
            ...
            #save the report
            write_yaml_file(self.model_eval_config.evaluation_report_file_path, model_eval_report)
            logging.info(f"Model evaluation artifact: {model_evaluation_artifact}")
            return model_evaluation_artifact
